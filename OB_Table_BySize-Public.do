preserve
	...
	file open TabEmpShares using Output/${CountryID}/Table_BySize_EmpShares-Public.tex, write replace
	file open TabAgeDist using Output/${CountryID}/Table_BySize_AgeDist-Public.tex, write replace
	file open TabNFirms using Output/${CountryID}/Table_BySize_NFirms-Public.tex, write replace
	file open TabNFirmsShare using Output/${CountryID}/Table_BySize_nFirmShares-Public.m, write replace
	file open TabEmpSharesMATLAB using Output/${CountryID}/Table_BySize_EmpShares-Public.m, write replace
	file open TabGrowth using Output/${CountryID}/Table_BySize_EmpGrowth-Public.m, write replace
