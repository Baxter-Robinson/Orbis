...
drop Closing_date Export_revenue Stock Market_capitalisation_mil Age  EmpGrowth_* SalesGrowth_h ProfitGrowth_h COGS_fHGR Revenue_fHGR Export_revenue_fHGR Assets_fHGR EBITDA_fHGR COGS_h Revenue_h Export_revenue_h Assets_h EBITDA_h EverPublic Private 
...
if "${CountryID}" == "FR" {
	gen EmpGrowth=(nEmployees2014-nEmployees2010)/nEmployees2010
	gen SalesGrowth=(Sales2014-Sales2010)/Sales2010
	gen SalesPerEmpGrowth=(SalesPerEmployee2014-SalesPerEmployee2014)/(SalesPerEmployee2014)

	** For each Firm Type
	collapse (mean) nEmployees2014 nEmployees2010  Sales2014 Sales2010 ///
	...
	gen EmpGrowth=(nEmployees2014-nEmployees2010)/nEmployees2010
	gen SalesGrowth=(Sales2014-Sales2010)/Sales2010
	gen SalesPerEmpGrowth=(Sales2014/nEmployees2014-Sales2010/nEmployees2010)/(Sales2010/nEmployees2010)

	twoway (bar EmpGrowth FirmType) , xtitle("Number of Shareholders") ytitle("Employment Growth (2010-2014)")  graphregion(color(white)) xlabel(  1 "1" 2 "2" 3 ">2"  6 "Public" )
