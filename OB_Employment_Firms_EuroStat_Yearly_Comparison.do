...
levelsof Year, local(levelyears)



foreach y of local levelyears{
			...
			*keep if Country=="IT"
			...
			graph export Output/$CountryID/OB_EuroStat_BySizeCat_ShareEmployment_`y'.pdf, replace 
			...
			graph export Output/$CountryID/OB_EuroStat_BySizeCat_nEmployees_`y'.pdf, replace 
			...
			graph export Output/$CountryID/OB_EuroStat_BySizeCat_nFirms_`y'.pdf, replace 
